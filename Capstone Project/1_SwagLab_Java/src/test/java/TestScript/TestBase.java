...
import Pages.SwagLoginCart_01_page;
import Pages.SwagLogin_01_page;
import Pages.SwagLogout_02_page;
import Utilities.ExcelUtil;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestBase {
	WebDriver driver;
	SwagLogin_01_page login;
    SwagLoginCart_01_page cart;
    SwagLogout_02_page logout;
	...
	public void Setup(String Browser,String url) {
		...
		login=new SwagLogin_01_page(driver);
		cart=new SwagLoginCart_01_page(driver);
		logout=new SwagLogout_02_page(driver);
		driver.get(url);
